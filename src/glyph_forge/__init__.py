...
_LAZY_EXPORTS: Final[Dict[str, Tuple[str, str]]] = {
    "AssetReference": ("glyph_forge.projects", "AssetReference"),
    "GlyphProject": ("glyph_forge.projects", "GlyphProject"),
    "ProjectError": ("glyph_forge.projects", "ProjectError"),
    "ProjectPersistenceError": (
        "glyph_forge.projects",
        "ProjectPersistenceError",
    ),
    "ProjectRecoveryError": ("glyph_forge.projects", "ProjectRecoveryError"),
    "ProjectSession": ("glyph_forge.projects", "ProjectSession"),
    "ProjectValidationError": (
        "glyph_forge.projects",
        "ProjectValidationError",
    ),
    "RecentProject": ("glyph_forge.projects", "RecentProject"),
    "RecentProjectStore": ("glyph_forge.projects", "RecentProjectStore"),
    "RenderPreset": ("glyph_forge.projects", "RenderPreset"),
    ...
    "BatchError": ("glyph_forge.batch", "BatchError"),
    "BatchItemResult": ("glyph_forge.batch", "BatchItemResult"),
    "BatchProgress": ("glyph_forge.batch", "BatchProgress"),
    "BatchRenderItem": ("glyph_forge.batch", "BatchRenderItem"),
    "BatchRenderReport": ("glyph_forge.batch", "BatchRenderReport"),
    "CancellationToken": ("glyph_forge.batch", "CancellationToken"),
    "items_for_sources": ("glyph_forge.batch", "items_for_sources"),
    "render_batch": ("glyph_forge.batch", "render_batch"),
    ...
    "AudioPolicy": ("glyph_forge.temporal", "AudioPolicy"),
    "FrameRate": ("glyph_forge.temporal", "FrameRate"),
    "FrameRounding": ("glyph_forge.temporal", "FrameRounding"),
    "ResolvedTimeline": ("glyph_forge.temporal", "ResolvedTimeline"),
    "TEMPORAL_CONTRACT_VERSION": (
        "glyph_forge.temporal",
        "TEMPORAL_CONTRACT_VERSION",
    ),
